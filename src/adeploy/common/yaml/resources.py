    ...
    if default_resource:
        for containers in find(doc, ["containers", "initContainers"]):
            for container in containers:
                ...
                container["resources"] = (
                    resources  # Update in case of newly created resource object!
                )

                log.debug(
                    f"...... Updating limits and requests for {colors.blue(doc_name + '/' + container_name)} ..."
                )
